            ...
            for video in videos:
                ...
                if get_face:
                    ...
                    for image_p in frames_names:
                        ...
                        if len(detection)>0:
                            point_right = detection[0]['keypoints']['mouth_right']
                            point_left  = detection[0]['keypoints']['mouth_left']
                            break
                    
                    for frame_name in frames_names:
                        img = cv2.imread('{}/{}'.format(frames_path, frame_name))
                        img = img[point_left[1]-90:point_left[1]+90, point_left[0]:point_right[0], :]
