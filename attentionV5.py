...
if __name__== "__main__":  
    ...
    note        = 'Nueva_Atención_MultiplicaciónVectoresDeCaracterísticas_VIDEO2D:weights' 
    s_duration  = False
    ...
    for patient in patients:
        ...
        Y_true, Y_pred, PK_props, C_props, sample_ids, exercises, repetitions, = train_model_CE_AUDIO_VIDEO_repeat2(
